	...
	<nav class="navbar top-navbar navbar-expand-md">
		<div class="navbar-header" data-logobg="skin6">
			...
			<div class="navbar-brand">
				<a href="index.html"> <b class="logo-icon">
					...
					<img src="<c:url value='/resources/images/logo-text.png'/>"
						alt="homepage" class="dark-logo" /> <!-- Light Logo text --> <img
						src="<c:url value='/resources/images/logo-light-text.png'/>" class="light-logo"
						alt="homepage" />
				</span>
				</a>
			</div>
		...
		<div class="navbar-collapse collapse" id="navbarSupportedContent">
			...
			<ul class="navbar-nav float-right">
				...
				<li class="nav-item dropdown"><a
					...
					data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
						<img src="<c:url value='/resources/images/profile-pic.jpg'/>" alt="user"
